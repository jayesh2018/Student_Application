...
public class QtnpprFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.fragment_qstnppr, container, false);

        recyclerView = rootView.findViewById(R.id.qstnpprrv);
        ...
        studentViewModel.getTheseDoc("Question Papers", subject).observe(this, new Observer<Document_Info[]>() {
            @Override
